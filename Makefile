...
lint:
	echo $(mkfile_dir)
	docker run --rm -v $(mkfile_dir):/app -w /app golangci/golangci-lint:v1.55.2 golangci-lint run -v -E goimports,unconvert,misspell,gocyclo,deadcode,errcheck,gosimple,govet,ineffassign,staticcheck,structcheck,typecheck,unused,varcheck,gocritic,gochecknoinits
